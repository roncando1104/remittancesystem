...
Class DataGridViewPrinter
    ...
    Public Sub New(aDataGridView As DataGridView, aPrintDocument As PrintDocument, CenterOnPage As Boolean, WithTitle As Boolean, aTitleText As String, aTitleFont As Font,
